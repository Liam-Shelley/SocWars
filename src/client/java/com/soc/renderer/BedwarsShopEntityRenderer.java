...
public class BedwarsShopEntityRenderer extends EntityRenderer<BedwarsShopEntity, BigTntRenderState> {
    ...
    @Override
    public void updateRenderState(BedwarsShopEntity entity, BigTntRenderState state, float tickProgress) {
