...
public record SkywarsItemData(float weightT1, float weightT2, float weightT3, float weightT4) {
    ...
    public SkywarsItemData(JsonObject json) {
        this(getDefaultedFloat(json, WEIGHT_T1_KEY), getDefaultedFloat(json, WEIGHT_T2_KEY), getDefaultedFloat(json, WEIGHT_T3_KEY), getDefaultedFloat(json, WEIGHT_T4_KEY));
    }
