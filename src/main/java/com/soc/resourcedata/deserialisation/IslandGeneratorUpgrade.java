...
public record IslandGeneratorUpgrade(int cost, int autoUpgradeTime, int ironTime, int ironCount, int ironMaxCount, int goldTime, int goldCount, int goldMaxCount, int emeraldTime, int emeraldCount, int emeraldMaxCount) implements Comparable<IslandGeneratorUpgrade> {
    ...
    public IslandGeneratorUpgrade(JsonObject json) {
        this(
                ...
                getDefaultedObject(json, TIME_KEY, Time::new, new Time(Integer.MAX_VALUE)).ticks(),
