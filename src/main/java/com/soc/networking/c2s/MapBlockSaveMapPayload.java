...
public record MapBlockSaveMapPayload(BlockLocation block) implements CustomPayload, HoldsBlockEntity {
    ...
    public static final PacketCodec<RegistryByteBuf, MapBlockSaveMapPayload> CODEC = PacketCodec.tuple(
            BlockLocation.PACKET_CODEC, MapBlockSaveMapPayload::block,
            MapBlockSaveMapPayload::new
    );
